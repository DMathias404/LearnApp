...
public class QuizActivity extends AppCompatActivity {
    ...
    public void startQuestion(int index) {
        ...
        Log.i("Question", lecture.getVocable());
        ...
        questionText.setText(lecture.getVocable());
    ...
    public void checkAnswer(Lecture l1, Lecture l2, Button b) {
        ...
        if (l1.equals(l2)) {
            ...
            for (Button but : buttonList) {
                if (l1.getMeaning().equals(but.getText().toString())) {
